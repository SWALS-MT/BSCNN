...
# 入力はミニバッチ数と現在のバッチ数
# 出力は画像を格納したNumpyの４次元配列
def ImageLoaderFromCOCO(minibatch_num, minibatch_count):
    ...
    print('Loading Images now... ( ' + str(minibatch_count + 1) +
          ' / ' + str(minibatch_num) + ' )')
    # データを読み込み、配列へ格納
...
if __name__ == '__main__':
    image, anns = ImageLoaderFromCOCO(20, 2)